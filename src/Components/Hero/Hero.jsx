    ...
    return (
        <section className='space-y-5 bg-gray-50 pt-20'>
            ...
            <div className='text-center space-x-5 mt-4'>
                <button className="btn font-bold text-lg bg-white border border-gray-200"><FaGooglePlay></FaGooglePlay>Google Play</button>
                <button className="btn font-bold text-lg bg-white border border-gray-200"><FaAppStoreIos></FaAppStoreIos>App Store</button>
            </div>
            <div>
